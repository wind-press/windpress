...
<template>
    <div class="sidebar-nav w:48 h:full flex-grow:0 flex-shrink:0">
        <!-- nav -->
        <div class="sidebar-nav-content flex flex:column h:full">
            <div class="composite-bar flex-grow:1 {fg:gray-60;font:24;py:14;mx:auto;text-align:center;w:full;bx:2|solid|transparent;cursor:pointer}>.sidebar-nav-item {fg:gray-95}>.sidebar-nav-item:hover {bl:sky-80}>.sidebar-nav-item.active">
                <div :class="{ active: showSidebar && activeSidebar === 'explorer' }" @click="doSwitch('explorer')" v-tooltip="{ placement: 'right', content: 'Explorer' }" class="sidebar-nav-item explorer">
            ...
            <div class="action-bar {fg:gray-60;font:24;py:14;mx:auto;text-align:center;w:full;bx:2|solid|transparent;cursor:pointer}>.sidebar-nav-item {fg:gray-95}>.sidebar-nav-item:hover">
                <div class="sidebar-nav-item help" v-tooltip="{ placement: 'right', content: 'Help' }">
    ...
    <div v-if="showSidebar" class="sidebar w:268 flex-grow:0 flex-shrink:0">
        <!-- sidebar -->
        <div class="sidebar__inner">
            <component :is="sidebarComponents[activeSidebar]" />
        </div>
    </div>
</template>