...
<template>
    <div class="r:12 h:full b:1|solid|gray-70/.2 b:gray-20/.2@dark box-shadow:0|2px|5px|rgba(0,0,0,.051) overflow:hidden">
        <div class="workspace-container flex flex:column h:full">
            <WindowHeader />

            <div class="window-body w:full flex flex:row flex-grow:1">
                <Sidebar />
                <MainPanel />
            </div>
