...
export function createLogComposable() {
  const welcomeLog: Log = {
    ...
    type: "debug",
    message:
      'Thank you for using WindPress! Join us on the Facebook Group: <a href="https://wind.press/go/facebook" target="_blank" class="underline">https://wind.press/go/facebook</a>',
    options: {
      raw: true,
    },
  };
