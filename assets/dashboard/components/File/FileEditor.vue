...
async function handleEditorMount(editor: monacoEditor.editor.IStandaloneCodeEditor, monaco: MonacoEditor) {
                                ...
                                tailwindcss: {
                                    ...
                                    atDirectives: [
                                        ...
                                        },
                                        {
                                            name: '@layer',
                                            status: 'standard',
                                            description: __('Use the `@layer` directive to tell Tailwind which “bucket” a set of custom styles belong to. Valid layers are `base`, `components`, and `utilities`.'),
                                            references: [
                                                {
                                                    name: __('Docs: Functions & Directives', 'windpress'),
    ...
    monacoDisposables.value.push(monaco.editor.addEditorAction({
