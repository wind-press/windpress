...
<template>
    <UModal :close="{ onClick: () => emit('close') }">
        ...
        <template #body>
            ...
            <UFormField label="Old Filename"  :description="i18n.__('The previous filename', 'windpress')" class="mb-2">
                <UInput :value="props.filePath" :disabled="true" class="w-full" />
            </UFormField>

            <UFormField label="New Filename" required :description="i18n.__('Filename may include a path. (css or js)', 'windpress')" :error="error">
