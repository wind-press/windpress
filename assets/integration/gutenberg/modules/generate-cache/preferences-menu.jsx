...
const WindPressIcon = () => {
  return <WindPressIconOriginal width={20} height={20} aria-hidden="true" focusable="false" />;
};
...
function WindPressSettingsSidebar() {
  ...
  return (
    <>
      <PluginSidebarMoreMenuItem target="windpress-settings" icon={<WindPressIcon />}>
